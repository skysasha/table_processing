...
id_mrigo_mrigo.to_csv(os.path.join('tables', 'csv', 'id_mrigo_mrigo.csv'), index=None, header=True)
...
id_okpdtr_okpdtr.to_csv(os.path.join('tables', 'csv', 'id_okpdtr_okpdtr.csv'), index=None, header=True)
